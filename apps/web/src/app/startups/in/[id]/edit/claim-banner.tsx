...
export default function ClaimBanner({ id }: { id: string }) {
  ...
  return (
    <div className="mx-auto mt-4 max-w-5xl rounded-xl border border-border bg-bg-raised px-4 py-3">
...
function CopyButton({
  ...
  return (
    <button
      ...
      className="flex items-center gap-2 rounded-lg border border-border px-3 py-1.5 text-sm text-text transition hover:bg-bg-subtle"
    >
